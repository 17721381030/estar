...
<body>
    ...
    <table style="margin-top:5px;">
    	<tbody>
		<tr>
        	<td style="width:32%;vertical-align: middle;">每页显示<s:textfield name="pageSize" cssClass="text"  size="3" cssStyle="margin-left:10px;margin-right:10px;padding:0px;text-align:center;height:20px;line-height:20px;width:40px;"/>&nbsp;条
             &nbsp;&nbsp;<span class="btn" onclick="setPageSize()" style="text-align:center;" onfocus="this.blur()">确定</span></td>
            <td style="width:18%;vertical-align: middle;"><s:text name="pageNo"/>/<s:text name="pageTotal"/>&nbsp;页&nbsp;<br/>总记录数&nbsp;<s:text name="recTotal"/></td>
