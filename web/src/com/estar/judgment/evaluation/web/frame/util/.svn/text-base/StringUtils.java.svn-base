...
public class StringUtils {
	...
	public static String string2Utf_8(String str){
		String returnStr = "";
    ...
    public static String truncateWhenUTF8(String s, int maxBytes) {
        if (s==null || s.length()==0 || maxBytes < 1)
            return "";
    ...
    public static String truncateWhenGBK(String str, int maxBytes) throws Exception {
        if (str==null || str.length()==0 || maxBytes < 1)
            return "";
        ...
        String s =null;
        if(count%2 == 0)
            s =new String(buf,0,maxBytes,"GBK");
        else
            s= new String(buf,0,maxBytes-1,"GBK");
        return s;
    }

    public static String  bSubstring (String s, int len, String encoding) throws Exception
    {
      if (s==null || s.length()==0 || len < 1)
          return "";
      if (encoding==null)
          throw new UnsupportedEncodingException();
      if ("GBK".equals(encoding)) {
          return truncateWhenGBK(s, len);
      } else if ("UTF-8".equals(encoding)) {
          return truncateWhenUTF8(s, len);
      } else {
          throw new UnsupportedEncodingException();
      }
    }
